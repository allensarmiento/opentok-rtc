<template>
  <div class="forbidden">
    ...
    <section id="screenShareErrors" class="screen-modal tc-modal">
      <div class="tc-dialog">
        ...
        <section id="screenShareErrorInstall">
          ...
          <footer>
            <button
              class="btn btn-blue btn-padding ctaarrow-white delete-archive"
            >
              Install extension
            </button>
          </footer>
        ...
        <section id="extInstallationSuccessful">
          ...
          <p>Once you have installed it, refresh your browser and click 'share screen' again.</p>
          <footer>
            <button class="btn btn-white btn-padding ctaarrow-blue">Later</button>
            <button class="btn btn-blue btn-padding ctaarrow-white">Reload</button>
          </footer>
        </section>
      </div>
    </section>
    ...
    <section class="tc-modal feedback-report">
      <div class="tc-dialog">
        <header>
          <i class="close" data-icon="close-gray_full"></i>
        ...
        <section data-tab="feedback">
          <form>
            <div class="call-quality-feedback">
              <!-- NOTE: Should this by within audio-feedback? -->
      ...
      <div class="tc-dialog">
        ...
        <section class="dialog-content">
          <div class="meeting-link">
            <input id="current-url" class="current-url" readonly />
